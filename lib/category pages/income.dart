      ...
      builder: (controller) => SingleChildScrollView(
        child: Padding(
          ...
          child: CustomCard(
            ...
            child: categoryC.incomeCategoryNotifier.isEmpty
                ? Stack(
                    children: [
                      Center(
                        child: Text(
                ...
                : Padding(
                    ...
                    child: GridView.builder(
                        ...
                        itemBuilder: (ctx, index) {
                          final categoryData =
                              categoryC.incomeCategoryNotifier[index];
                          return Container(
                                    ...
                                    showDialog(
                                      ...
                                      builder: (ctx) => AlertDialog(
                                        ...
                                        actions: <Widget>[
                                          TextButton(
                                            onPressed: () async {
                                              await CategoryDbFunction.instance
                        ...
                        itemCount: categoryC.incomeCategoryNotifier.length),
                  ),
          ),
        ),
      ),
